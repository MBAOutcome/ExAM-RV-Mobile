...
const routes = [
    {
        path: 'home',
        loadChildren: () => Promise.all(/*! import() | home-home-module */[__webpack_require__.e("default~edit-link-edit-link-module~home-home-module"), __webpack_require__.e("common"), __webpack_require__.e("home-home-module")]).then(__webpack_require__.bind(null, /*! ./home/home.module */ "./src/app/home/home.module.ts")).then(m => m.HomePageModule),
    ...
    {
        path: 'videomodel',
        loadChildren: () => Promise.all(/*! import() | videomodel-videomodel-module */[__webpack_require__.e("common"), __webpack_require__.e("videomodel-videomodel-module")]).then(__webpack_require__.bind(null, /*! ./videomodel/videomodel.module */ "./src/app/videomodel/videomodel.module.ts")).then(m => m.VideomodelPageModule)
    },
    {
        path: 'edit-link',
        loadChildren: () => Promise.all(/*! import() | edit-link-edit-link-module */[__webpack_require__.e("default~edit-link-edit-link-module~home-home-module"), __webpack_require__.e("edit-link-edit-link-module")]).then(__webpack_require__.bind(null, /*! ./edit-link/edit-link.module */ "./src/app/edit-link/edit-link.module.ts")).then(m => m.EditLinkPageModule)
    },
];
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, loaderservice, router, authenticationService) {
...
/* harmony import */ var _ionic_native_deeplinks_ngx__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @ionic-native/deeplinks/ngx */ "./node_modules/@ionic-native/deeplinks/__ivy_ngcc__/ngx/index.js");
...
let LoaderService = class LoaderService {
    ...
    hideLoading() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            this.isLoading = false;
            yield this.loadingController.dismiss().then(() => console.log('dismissed'));
        });
    }
};
...
module.exports = __webpack_require__(/*! /Users/sivasankar/Documents/ExAM RV Project and details/ExAM RV Final/ExAM_RV/src/main.ts */"./src/main.ts");
