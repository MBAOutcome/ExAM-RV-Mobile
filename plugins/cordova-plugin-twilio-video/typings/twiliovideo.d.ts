declare module TwilioVideo {
  interface TwilioVideoPlugin {
     ...
     * @param config.lat 
     * @param config.log
     * @param config.roomownerid
     * @param config.schemacolor
     * @param config.headerBtnColor
     * @param config.headerBtnTextColor
     * @param config.headerValue
     * @param config.appversion
     */
